...
const apiKey = "69e4a1e50d8866dc9cf38c145f905997" // Replace with your actual API key
let api
...
function requestApi(city) {
	api = `https://api.openweathermap.org/data/3.0/weather?q=${city}&units=metric&appid=${apiKey}`
	fetchData()
}

function onSuccess(position) {
	const { latitude, longitude } = position.coords
	api = `https://api.openweathermap.org/data/3.0/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=${apiKey}`
	fetchData()
}
